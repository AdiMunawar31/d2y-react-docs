...
export function HeroActions() {
  return (
    <div className="flex flex-wrap items-center gap-4 w-full">
      ...
      <button className="inline-flex h-12 items-center justify-center gap-2 rounded-xl border border-glass-border bg-white/5 px-8 text-base font-bold text-white backdrop-blur-sm transition-all hover:bg-white/10 hover:border-white/20 focus:outline-none focus:ring-2 focus:ring-white/20">
        <Wrench size={16} />
